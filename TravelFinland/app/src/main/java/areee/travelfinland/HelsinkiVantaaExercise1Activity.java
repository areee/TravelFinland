...
public class HelsinkiVantaaExercise1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root.setBackground(getResources().getDrawable(R.drawable.helsinki_world_championships_in_athletics));
        ...
        checkBox1.setText(R.string.helsinki_exercise1_alternative1);
        checkBox2.setText(R.string.helsinki_exercise1_alternative2);
        checkBox3.setText(R.string.helsinki_exercise1_alternative3);
        checkBox4.setText(R.string.helsinki_exercise1_alternative4);
        checkBox5.setText(R.string.helsinki_exercise1_alternative5);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!checkBox1.isChecked() && checkBox2.isChecked() && checkBox3.isChecked()
                    ...
                    editor.putInt("doneHelsinkiVantaaExercise1", 1);
                    editor.commit();
