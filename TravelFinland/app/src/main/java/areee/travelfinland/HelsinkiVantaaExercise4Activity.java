...
public class HelsinkiVantaaExercise4Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox3.setText(R.string.helsinki_exercise4_alternative3);
        checkBox4.setText(R.string.helsinki_exercise4_alternative4);
        checkBox5.setText(R.string.helsinki_exercise4_alternative5);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox1.isChecked() && checkBox2.isChecked() && checkBox3.isChecked()
                    ...
                    editor.putInt("doneHelsinkiVantaaExercise4", 1);
                    editor.commit();
