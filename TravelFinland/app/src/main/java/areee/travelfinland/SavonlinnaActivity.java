...
public class SavonlinnaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent exercise1 = new Intent(getApplicationContext(), SavonlinnaExercise1Activity.class);
        ...
        exerciseButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent exercise2 = new Intent(getApplicationContext(), SavonlinnaExercise2Activity.class);
        ...
        exerciseButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent exercise3 = new Intent(getApplicationContext(), SavonlinnaExercise3Activity.class);
...
//                startActivity(exercise4);
                Intent exercise4 = new Intent(getApplicationContext(), SavonlinnaExercise4Activity.class);
                startActivity(exercise4);
            }
        });
