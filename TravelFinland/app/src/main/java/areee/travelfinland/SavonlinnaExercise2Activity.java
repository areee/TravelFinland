...
public class SavonlinnaExercise2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox1.setText(R.string.savonlinna_exercise2_alternative1);
        checkBox2.setText(R.string.savonlinna_exercise2_alternative2);
        checkBox3.setText(R.string.savonlinna_exercise2_alternative3);
        checkBox4.setText(R.string.savonlinna_exercise2_alternative4);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox1.isChecked() && checkBox3.isChecked() && checkBox2.isChecked() &&
                    ...
                    editor.putInt("doneSavonlinnaExercise2", 1);
                    editor.commit();
