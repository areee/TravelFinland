...
public class SavonlinnaExercise3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox1.setText(R.string.savonlinna_exercise3_alternative1);
        checkBox2.setText(R.string.savonlinna_exercise3_alternative2);
        checkBox3.setText(R.string.savonlinna_exercise3_alternative3);
        checkBox4.setText(R.string.savonlinna_exercise3_alternative4);
        checkBox5.setText(R.string.savonlinna_exercise3_alternative5);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!checkBox1.isChecked() && checkBox2.isChecked() && checkBox3.isChecked()
                    ...
                    editor.putInt("doneSavonlinnaExercise3", 1);
                    editor.commit();
