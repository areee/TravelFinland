...
public class SavonlinnaInformationDialog extends DialogFragment {
...
//        });
        ...
        builder.setMessage(R.string.savonlinna_info_box);
        builder.setPositiveButton(R.string.ok_button_text, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                .setNeutralButton(R.string.listen_button_text, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MediaPlayer mediaPlayer = MediaPlayer.create(getActivity(), R.raw.nyslott_spoken_text_box);
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            @Override
                            public void onCompletion(MediaPlayer mp) {
                                mp.release();
