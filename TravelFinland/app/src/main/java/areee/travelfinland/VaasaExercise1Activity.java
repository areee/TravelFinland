...
public class VaasaExercise1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root.setBackground(getResources().getDrawable(R.drawable.vaasa_church_from_water_tower));
        ...
        checkBox1.setText(R.string.vaasa_exercise1_alternative1);
        checkBox2.setText(R.string.vaasa_exercise1_alternative2);
        checkBox3.setText(R.string.vaasa_exercise1_alternative3);
        checkBox4.setText(R.string.vaasa_exercise1_alternative4);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox1.isChecked() && checkBox3.isChecked() && !checkBox2.isChecked() &&
                    ...
                    editor.putInt("doneVaasaExercise1", 1);
                    editor.commit();
